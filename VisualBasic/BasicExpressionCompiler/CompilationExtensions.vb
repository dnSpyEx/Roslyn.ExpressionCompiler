...
Namespace Microsoft.CodeAnalysis.VisualBasic.ExpressionEvaluator
    ...
    Friend Module CompilationExtensions
        ...
        <Extension>
        Friend Function GetSourceMethod(compilation As VisualBasicCompilation, compiler As CompilerKind, moduleId As ModuleId, methodHandle As MethodDefinitionHandle) As PEMethodSymbol
                ...
                For Each member In containingType.ContainingType.GetMembers(sourceMethodName)
                    ...
                    If candidateMethod IsNot Nothing Then
                        ...
                        If metadataDecoder.Module.HasStateMachineAttribute(candidateMethod.Handle, stateMachineTypeName) AndAlso
                            SymbolEqualityComparer.Default.Equals(metadataDecoder.GetTypeSymbolForSerializedType(stateMachineTypeName).OriginalDefinition, containingType) Then
